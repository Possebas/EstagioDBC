...
public class Main {
	...
	public static void main(String[] args) {
		...
		endereco1.setBairros(saoJose);
		endereco2.setLogradouro("Rua Albion");
		endereco2.setNumero("198");
		endereco2.setBairros(centro);
		endereco3.setLogradouro("Rua 30");
		endereco3.setNumero("31");
		endereco3.setBairros(centro);
		endereco4.setLogradouro("Avenida hogwarts");
		endereco4.setNumero("10");
		endereco4.setBairros(saoJose);
		enderecosService.salvar(endereco1);
		enderecosService.salvar(endereco2);
		enderecosService.salvar(endereco3);
		...
		banco1.setNome("Hogwarts");
		banco1.setCodigo(111);
		banco2.setNome("Pokstista");
		banco2.setCodigo(159);
		bancosService.salvar(banco1);
		bancosService.salvar(banco2);
		...
		agencia1.setBancos(banco1);
		agencia1.setCodigo(1);
		agencia1.setEnderecos(endereco1);
		agenciasService.salvar(agencia1);
		agencia2.setNome("Agencia Belem");
		agencia2.setBancos(banco2);
		agencia2.setCodigo(1);
		agencia2.setEnderecos(endereco2);
		agenciasService.salvar(agencia2);
		...
		cliente1.setEnderecos(endereco1);
		...
		cliente2.setEnderecos(endereco2);
		...
		conta1.setTipo(TiposCorrentistas.PF);
		conta1.depositar(100.0);
		conta2.setTipo(TiposCorrentistas.PF);
		conta2.depositar(100.0);
		correntistasService.salvar(conta1);
